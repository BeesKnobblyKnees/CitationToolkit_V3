...
st.markdown('<div class="app-label">A practical group &nbsp; 5 of 5</div>', unsafe_allow_html=True)
st.markdown("## Figure *Inventory*")
st.markdown("Cross-check figures, tables, and plates against a naming sheet.")
st.divider()
