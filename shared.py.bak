...
/* Sidebar button inner text — dark ink, not cream */
...
/* Primary buttons — maroon with cream text */
button[kind="primary"],
...
/* Target the <p> Streamlit wraps button text in */
.stButton > button p,
...
/* Expanders — text-indent trick hides leaked _arr on Safari + Chrome */
...
div[data-testid="stExpander"] details > summary::marker { display: none !important; content: "" !important; }
div[data-testid="stExpander"] details > summary:hover { background: var(--bg2) !important; }
/* Restore font size on all real child elements */
div[data-testid="stExpander"] details > summary > *,
...
/* Label text inside summary — restore font-size hidden on parent */
div[data-testid="stExpander"] details > summary p,
div[data-testid="stExpander"] details > summary span,
div[data-testid="stExpander"] details > summary div,
div[data-testid="stExpander"] details > summary label {
...
/* Hide Streamlit's internal arrow text node in expander headers */
div[data-testid="stExpander"] details > summary > div:first-child,
...
/* But keep the SVG arrow visible */
div[data-testid="stExpander"] details > summary > div:first-child svg,
div[data-testid="stExpander"] details > summary > span:first-child svg {
...
/* Safari/Mac specific: cover _arr leaked text with pseudo-element */
