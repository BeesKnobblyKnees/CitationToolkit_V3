    ...
    st.markdown(\'<div class="section-rule">Step 0 — Extract traveling library references</div>\', unsafe_allow_html=True)
    ...
    st.markdown(\'<div class="section-rule">Step 0b — Remap citations still showing as Traveling Library</div>\', unsafe_allow_html=True)
    ...
    if stage1_done and not stage2_done:
        ...
        st.markdown(\'<div class="section-rule">Enter db-id manually</div>\', unsafe_allow_html=True)
